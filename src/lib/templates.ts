  ...
  },
  {
    ...
    build: (title, station) => newQuestView(title, {
      ...
      steps: [
        ...
        newStep({ name: 'Hand over', journal: 'Open the station menu at Cooper City.', finishWhen: 'ACTION_CLICK_STATION_Cooper City', dialogue: [newLine({ speaker: 'Harry', portrait: 'Tourist2', text: 'Good. We never met.' })] }),
      ],
      rumors: [],
    }),
  },
...
export function sampleMods(): QuestView[] {
  ...
  return [choice, haul.mod as QuestView]
}
